 ...
 * @since 1.0.0
 */
class TZT_Video_Widget extends Widget_Base {
	...
	public function get_title() {
		return __( 'Camp Video', 'elementor' );
	}
	...
	protected function render() {
		...
		if ( empty( $video_url ) ) {
			?>
<div class="camp_main_img no_video">
<img src=" <?php echo \elementor\Group_Control_Image_Size::get_attachment_image_src( $settings['image_overlay']['id'], 'image_overlay', $settings ); ?>
		  " width="200px" alt="test">
</div>
<?php
			return;
		}
		...
		if ( 'hosted' === $settings['video_type'] ) {
			...
			$video_html = \Donations\Embed::get_embed_html( $video_url, $embed_params, $embed_options );
		}
